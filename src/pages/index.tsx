  ...
  return (
    <>
      ...
      <main className="px-3 text-white">
        <section className="mb-5 h-[385px] rounded-md bg-main-banner bg-cover bg-right">
        ...
        <section className="mb-5 h-[250px] rounded-md bg-trainers-banner bg-cover bg-center md:h-[300px] lg:h-[400px] xl:h-[500px]">
